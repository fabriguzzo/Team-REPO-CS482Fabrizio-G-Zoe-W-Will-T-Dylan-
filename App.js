...
const invitationController = require("./Docs/Baseball/Controller/invitationController");
...
/* -------------------- INVITATION ROUTES -------------------- */
app.post("/invitations", invitationController.send);
app.get("/invitations", invitationController.getAll);
app.get("/invitations/user/:userId", invitationController.getByRecipient);
app.get("/invitations/team/:teamId", invitationController.getByTeam);
app.put("/invitations/:id/accept", invitationController.accept);
app.put("/invitations/:id/decline", invitationController.decline);
app.delete("/invitations/:id", invitationController.delete);
